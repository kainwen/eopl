...
yystate(49, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
yystate(49, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
...
yystate(46, [C|Ics], Line, Tlen, Action, Alen) when C >= 113, C =< 115 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
yystate(46, [C|Ics], Line, Tlen, Action, Alen) when C >= 118, C =< 121 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
...
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 122 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
...
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 106 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 108, C =< 122 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
