...
yystate(50, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(25, Ics, Line, Tlen+1, 15, Tlen);
yystate(50, [C|Ics], Line, Tlen, _, _) when C >= 100, C =< 122 ->
    yystate(25, Ics, Line, Tlen+1, 15, Tlen);
...
yystate(49, [106|Ics], Line, Tlen, Action, Alen) ->
...
yystate(49, [40|Ics], Line, Tlen, Action, Alen) ->
    yystate(39, Ics, Line, Tlen+1, Action, Alen);
yystate(49, [41|Ics], Line, Tlen, Action, Alen) ->
    yystate(39, Ics, Line, Tlen+1, Action, Alen);
...
yystate(49, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(25, Ics, Line, Tlen+1, Action, Alen);
yystate(49, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 104 ->
    yystate(25, Ics, Line, Tlen+1, Action, Alen);
yystate(49, [C|Ics], Line, Tlen, Action, Alen) when C >= 109, C =< 111 ->
    yystate(25, Ics, Line, Tlen+1, Action, Alen);
yystate(49, [C|Ics], Line, Tlen, Action, Alen) when C >= 113, C =< 115 ->
    yystate(25, Ics, Line, Tlen+1, Action, Alen);
yystate(49, [C|Ics], Line, Tlen, Action, Alen) when C >= 118, C =< 121 ->
    yystate(25, Ics, Line, Tlen+1, Action, Alen);
...
yystate(33, Ics, Line, Tlen, _, _) ->
    {15,Tlen,Ics,Line,33};
yystate(32, [112|Ics], Line, Tlen, _, _) ->
...
yystate(32, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(25, Ics, Line, Tlen+1, 15, Tlen);
yystate(32, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 111 ->
    yystate(25, Ics, Line, Tlen+1, 15, Tlen);
yystate(32, [C|Ics], Line, Tlen, _, _) when C >= 113, C =< 122 ->
    yystate(25, Ics, Line, Tlen+1, 15, Tlen);
...
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(25, Ics, Line, Tlen+1, 15, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 120 ->
    yystate(25, Ics, Line, Tlen+1, 15, Tlen);
...
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(25, Ics, Line, Tlen+1, 15, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 106 ->
    yystate(25, Ics, Line, Tlen+1, 15, Tlen);
