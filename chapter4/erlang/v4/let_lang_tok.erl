...
yystate(88, [112|Ics], Line, Tlen, _, _) ->
...
yystate(88, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
yystate(88, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 111 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
yystate(88, [C|Ics], Line, Tlen, _, _) when C >= 113, C =< 122 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
...
yystate(86, Ics, Line, Tlen, _, _) ->
    {15,Tlen,Ics,Line,86};
yystate(85, [122|Ics], Line, Tlen, Action, Alen) ->
...
yystate(85, [106|Ics], Line, Tlen, Action, Alen) ->
    yystate(61, Ics, Line, Tlen+1, Action, Alen);
yystate(85, [107|Ics], Line, Tlen, Action, Alen) ->
    yystate(61, Ics, Line, Tlen+1, Action, Alen);
...
yystate(85, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(61, Ics, Line, Tlen+1, Action, Alen);
yystate(85, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 104 ->
    yystate(61, Ics, Line, Tlen+1, Action, Alen);
yystate(85, [C|Ics], Line, Tlen, Action, Alen) when C >= 118, C =< 121 ->
    yystate(61, Ics, Line, Tlen+1, Action, Alen);
...
yystate(78, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
yystate(78, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 107 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
...
yystate(69, [63|Ics], Line, Tlen, _, _) ->
    yystate(65, Ics, Line, Tlen+1, 23, Tlen);
...
yystate(66, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
yystate(66, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
...
yystate(57, [110|Ics], Line, Tlen, _, _) ->
    yystate(53, Ics, Line, Tlen+1, 23, Tlen);
...
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 118 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
...
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 107 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 109, C =< 113 ->
    yystate(61, Ics, Line, Tlen+1, 23, Tlen);
