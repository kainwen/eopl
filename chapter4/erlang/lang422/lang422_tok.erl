...
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 42 ->
    yystate(21, Ics, Line, Tlen+1, Action, Alen);
...
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 104 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 109 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 113, C =< 117 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
