...
yystate(75, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(50, Ics, Line, Tlen+1, 21, Tlen);
yystate(75, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(50, Ics, Line, Tlen+1, 21, Tlen);
yystate(75, [C|Ics], Line, Tlen, _, _) when C >= 111, C =< 122 ->
    yystate(50, Ics, Line, Tlen+1, 21, Tlen);
yystate(75, Ics, Line, Tlen, _, _) ->
    {21,Tlen,Ics,Line,75};
yystate(74, [122|Ics], Line, Tlen, Action, Alen) ->
...
yystate(74, [109|Ics], Line, Tlen, Action, Alen) ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
yystate(74, [108|Ics], Line, Tlen, Action, Alen) ->
    yystate(57, Ics, Line, Tlen+1, Action, Alen);
yystate(74, [106|Ics], Line, Tlen, Action, Alen) ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
yystate(74, [107|Ics], Line, Tlen, Action, Alen) ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
...
yystate(74, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
yystate(74, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 104 ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
yystate(74, [C|Ics], Line, Tlen, Action, Alen) when C >= 118, C =< 121 ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
...
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(50, Ics, Line, Tlen+1, 21, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 114 ->
    yystate(50, Ics, Line, Tlen+1, 21, Tlen);
...
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(50, Ics, Line, Tlen+1, 21, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 100, C =< 122 ->
    yystate(50, Ics, Line, Tlen+1, 21, Tlen);
