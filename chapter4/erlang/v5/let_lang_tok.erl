...
yystate(60, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(36, Ics, Line, Tlen+1, Action, Alen);
yystate(60, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 104 ->
    yystate(36, Ics, Line, Tlen+1, Action, Alen);
yystate(60, [C|Ics], Line, Tlen, Action, Alen) when C >= 109, C =< 111 ->
    yystate(36, Ics, Line, Tlen+1, Action, Alen);
yystate(60, [C|Ics], Line, Tlen, Action, Alen) when C >= 118, C =< 121 ->
    yystate(36, Ics, Line, Tlen+1, Action, Alen);
...
yystate(59, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(36, Ics, Line, Tlen+1, 19, Tlen);
yystate(59, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(36, Ics, Line, Tlen+1, 19, Tlen);
...
yystate(19, Ics, Line, Tlen, _, _) ->
    {19,Tlen,Ics,Line,19};
yystate(18, [103|Ics], Line, Tlen, _, _) ->
...
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(36, Ics, Line, Tlen+1, 19, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 102 ->
    yystate(36, Ics, Line, Tlen+1, 19, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 104, C =< 122 ->
    yystate(36, Ics, Line, Tlen+1, 19, Tlen);
...
yystate(17, Ics, Line, Tlen, _, _) ->
    {11,Tlen,Ics,Line,17};
yystate(16, [107|Ics], Line, Tlen, _, _) ->
...
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(36, Ics, Line, Tlen+1, 19, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 106 ->
    yystate(36, Ics, Line, Tlen+1, 19, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 108, C =< 122 ->
    yystate(36, Ics, Line, Tlen+1, 19, Tlen);
