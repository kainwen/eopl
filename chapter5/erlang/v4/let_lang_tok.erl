...
yystate(73, Ics, Line, Tlen, _, _) ->
    {24,Tlen,Ics,Line,73};
yystate(72, [122|Ics], Line, Tlen, Action, Alen) ->
...
yystate(72, [106|Ics], Line, Tlen, Action, Alen) ->
    yystate(48, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [107|Ics], Line, Tlen, Action, Alen) ->
    yystate(48, Ics, Line, Tlen+1, Action, Alen);
...
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 104 ->
    yystate(48, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 121 ->
    yystate(48, Ics, Line, Tlen+1, Action, Alen);
...
yystate(57, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
yystate(57, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
yystate(57, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
...
yystate(51, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 100 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
yystate(51, [C|Ics], Line, Tlen, _, _) when C >= 102, C =< 104 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
...
yystate(45, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
yystate(45, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 106 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
yystate(45, [C|Ics], Line, Tlen, _, _) when C >= 108, C =< 122 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
...
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 100 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 102, C =< 113 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
...
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(48, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 101, C =< 110 ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
