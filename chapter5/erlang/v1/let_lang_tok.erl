...
yystate(31, [106|Ics], Line, Tlen, Action, Alen) ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(31, [107|Ics], Line, Tlen, Action, Alen) ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
...
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 100 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 104 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 109, C =< 111 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 113, C =< 115 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 121 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
...
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(7, Ics, Line, Tlen+1, 12, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(7, Ics, Line, Tlen+1, 12, Tlen);
