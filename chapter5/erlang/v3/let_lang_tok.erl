...
yystate(66, [113|Ics], Line, Tlen, Action, Alen) ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [112|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [111|Ics], Line, Tlen, Action, Alen) ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
...
yystate(66, [106|Ics], Line, Tlen, Action, Alen) ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [107|Ics], Line, Tlen, Action, Alen) ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [105|Ics], Line, Tlen, Action, Alen) ->
...
yystate(66, [100|Ics], Line, Tlen, Action, Alen) ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [99|Ics], Line, Tlen, Action, Alen) ->
...
yystate(66, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 104 ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 121 ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
...
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
...
yystate(59, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(42, Ics, Line, Tlen+1, 7, Tlen);
yystate(59, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 117 ->
    yystate(42, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(41, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 100 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
yystate(41, [C|Ics], Line, Tlen, _, _) when C >= 102, C =< 104 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
...
yystate(38, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
yystate(38, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 113 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
...
yystate(34, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
yystate(34, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 120 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
...
yystate(0, [98|Ics], Line, Tlen, _, _) ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
yystate(0, [99|Ics], Line, Tlen, _, _) ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
...
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 101, C =< 110 ->
    yystate(42, Ics, Line, Tlen+1, 21, Tlen);
